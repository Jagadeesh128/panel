 ...
 */
final class Version20240209111027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE contact CHANGE mobilenumber mobilenumber INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE contact CHANGE mobilenumber mobilenumber BIGINT DEFAULT NULL');
